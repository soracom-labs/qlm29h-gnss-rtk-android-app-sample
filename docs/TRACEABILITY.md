...
| `NET-01`, `NET-02` | `AndroidConnectivityMonitor.kt`, `InternetReachability.kt`, `RtkRuntime.onInternetReachabilityChanged`, `AppDiagnosticsState.communicationEvents`, `MapUiState.kt`, `DiagnosticsCard.kt` | `InternetReachabilityPolicyTest.kt`, `RtkRuntimeIntegrationTest.kt`, `AppStateTest.kt`, `SettingsUiStateTest.kt`, `MapUiStateTest.kt`、VPN有効中の実機通信切断試験 |
